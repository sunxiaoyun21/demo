...
import com.example.annotation.LocalCache;
import com.example.annotation.LocalCacheRemove;
...
public class LocalCacheAop {
     ...
     * LocalCache切入点规则
     */
    @Pointcut(value = "@annotation(com.example.annotation.LocalCache)")
     ...
     */
    @Pointcut(value = "@annotation(com.example.annotation.LocalCacheRemove)")
