...
import annotation.LocalCache;
import annotation.LocalCacheRemove;
...
public class LocalCacheAop {
     ...
     * LocalCache切入点规则
     */
    @Pointcut(value = "@annotation(com.zhichu.company.core.annotation.LocalCache)")
     ...
     */
    @Pointcut(value = "@annotation(com.zhichu.company.core.annotation.LocalCacheRemove)")
